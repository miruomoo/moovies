...
function StarRating({maxRating = 5, color='#fcc419', size=48, messages=[], defaultRating=0, onSetRating}){
    ...
    <div style={containerStyle}>
        <div style={starContainerStyle}>
            {Array.from({length: maxRating}, (_, i) => (
                ...
                full={tempRating? tempRating>=i+1?true:false : rating>=i+1?true:false}
